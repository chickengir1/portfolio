const Folder = () => {
  return (
    <div className="folder group relative w-32 h-20 bg-gray-600 rounded-bl-[8px] rounded-br-[8px] rounded-tr-[8px] cursor-pointer transition-all duration-300">
      ...
      <div className="absolute inset-0 m-auto w-11/12 h-5/6 bg-gray-200 rounded-lg shadow-md transform scale-y-[1] skew-x-[0deg] transition-transform duration-300 group-hover:skew-x-[-5deg] group-hover:translate-y-[-10px]"></div>
